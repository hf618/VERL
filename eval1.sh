...
RUN_NAME_MAP=(
    ["1"]="llama/Llama-3.2-3B-Instruct_GRPO_old_regu_explore_verl_max_prompt512_max_response1280_grpo_batch48_ppomini24_valbatch48_rollout4_logprobbatch12_klcoef0.001_entcoef0.001_epochs2_simplelr_abel_level1to4_stride40_mgain2.0_auxgw1.0_ema0.3"
)
