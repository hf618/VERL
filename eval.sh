...
# Available options: "FULL_SAMPLES_PASS1", "SMALL_SAMPLES_PASS16", "LITTLE_SAMPLES_PASS32", "TINY_SAMPLES_PASS256"

ACTIVE_CONFIG_SETS=("FULL_SAMPLES_PASS1" "SMALL_SAMPLES_PASS16" "LITTLE_SAMPLES_PASS32" "TINY_SAMPLES_PASS256")
TEMPERATURES=(0.6)
EVAL_SEED="42"
VISIBLE_GPUS="2"
TP_SIZE=$(echo "$VISIBLE_GPUS" | tr ',' '\n' | awk 'NF{c++} END{print c+0}')
if [ "$TP_SIZE" -le 0 ]; then TP_SIZE=1; fi
...
BENCHMARK_SETS=(
["FULL_SAMPLES_PASS1"]="math24o,OlymMATH-EN-EASY,OlymMATH-EN-HARD,OlymMATH-ZH-EASY,OlymMATH-ZH-HARD,BeyondAIME,aime25,amc24,aime24,amc23,aqua,asdiv,carp_en,cmath,cn_middle_school,college_math,gaokao2023en,gaokao2024_I,gaokao2024_II,gaokao2024_mix,gaokao_math_cloze,gaokao_math_qa,gsm8k,math,math500,mawps,minerva_math,mmlu_stem,olympiadbench,sat_math,svamp,tabmwp"
